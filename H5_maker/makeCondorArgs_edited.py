...
datasets = {
    ...
    "2016": {
       ...
       #"JetHT_Run2016F":  "/store/user/lpcpfnano/cmantill/v2_3/2016/JetHT2016/JetHT/JetHT_Run2016F/220701_193506/0000/",
       #"JetHT_Run2016G":  "/store/user/lpcpfnano/cmantill/v2_3/2016/JetHT2016/JetHT/JetHT_Run2016G/220701_193626/0000/",
       #"JetHT_Run2016H": "/store/user/lpcpfnano/cmantill/v2_3/2016/JetHT2016/JetHT/JetHT_Run2016H/220701_193717/0000/",
        ...
        "TTToHadronic": "../../H5_Storage/PFNano_with_systematics/2016/TTToHadronic/",
    ...
    "2016APV": {
        ...
        "TTToHadronic": "../../H5_Storage/PFNano_with_systematics/2016APV/TTToHadronic/",
    ...
    "2018": {
       ...
       "TTToHadronic": "../../H5_Storage/PFNano_with_systematics/2018/TTToHadronic/",
...
if __name__=='__main__':
	...
	# create arg file
	argFile = open('h5_arg_{}_realdata.txt'.format(year),'w')
...
fNames = subprocess.check_output(['ls ../../H5_Storage/PFNano_with_systematics/{}/{}/'.format(year,'TTToHadronic')],shell=True).split('\n')
fNames.remove('')

for fName in fNames:
	        # create arguments
	iFile = '../../H5_Storage/PFNano_with_systematics/{}/TTToHadronic/{}'.format(year, fName)
	oFile = 'h5_with_systematics/{}/TTToHadronic/{}_{}_{}.h5'.format(year, process, fName.split('.')[0].replace('_','-'), year)
	iYear = 2016 if 'APV' in year else year
	        # write to file
    print('python make_h5_local.py -i {} -o {} -y {} -f {}'.format(iFile, oFile, iYear, f))
	subprocess.call('python make_h5_local.py -i {} -o {} -y {} -f {}'.format(iFile, oFile, iYear, f))
